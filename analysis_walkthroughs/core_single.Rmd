...
Linear models fit to many individual timeseries may underestimate p values, but we are interested in the route-level slopes more so than in an overall "main" slope.
