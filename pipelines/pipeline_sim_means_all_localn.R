...
db <- DBI::dbConnect(RSQLite::SQLite(), here::here("aspirational_structure", "drake_caches", "all_localn.sqlite"))
...
#
 ...
 save(all_sims, all_winners,  all_qis, all_diagnostics, file = "portable_results_all_localn.Rds")
rm(all_sims)
rm(all_winners)
rm(all_qis)
rm(all_diagnostics)
