...
ggplot(all_composition, aes(composition_overlap)) + geom_histogram(bins = 100) 

all_composition <- left_join(all_composition, all_overlaps)


ggplot(all_composition, aes(composition_overlap, overlap)) + geom_point() + geom_abline(intercept = 0, slope = 1)

ggplot(all_composition, aes(overlap - composition_overlap)) + geom_histogram(bins = 100)
all_overlaps %>%
  summarize(mean_overlap = mean(overlap),
            sd_overlap = sd(overlap))
