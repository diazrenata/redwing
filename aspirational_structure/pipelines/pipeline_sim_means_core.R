...
db <- DBI::dbConnect(RSQLite::SQLite(), here::here("aspirational_structure", "drake_caches", "core.sqlite"))
...
#
 ...
 save(all_sims, all_winners,  all_qis, all_diagnostics, file = "portable_results_core.Rds")
