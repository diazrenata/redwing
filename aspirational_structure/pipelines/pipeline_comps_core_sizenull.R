...
db <- DBI::dbConnect(RSQLite::SQLite(), here::here("aspirational_structure", "drake_caches", "comps_core_sizenull.sqlite"))
...
#
 ...
 save(all_comps, file = "portable_comps_core_sizenull.Rds")
