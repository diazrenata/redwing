...
* 7 (for biomass) and 8 (for energy) models don't pick up on any difference begin-end
* 11 (for biomass) and 7 (for energy) models pick up on *different* dynamics for the currency than if the size structure were more or less replicated. 
* Biomass picks up on an interaction more often than energy.
* These tallies don't tell us how often the abundance slope is nonzero in the full models
